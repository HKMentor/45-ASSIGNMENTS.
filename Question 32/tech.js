...
let current_users3 = ["honey", "dev", "kashan", "okasha", "rehim"];
// List of new users
let new_users33 = ["Hamza", "Ramiz", "Nakash", "faiz", "Bilal"];
// Convert all current usernames to lowercase for case-insensitive comparison
let current_users_lower = current_users3.map(username => username.toLowerCase());
...
new_users33.forEach(new_user33 => {
    ...
    let new_user_lower = new_user33.toLowerCase();
